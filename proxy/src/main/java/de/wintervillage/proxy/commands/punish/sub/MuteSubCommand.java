...
public class MuteSubCommand {

    private final WinterVillage winterVillage;

    private final PlayerManager playerManager;

    public MuteSubCommand(WinterVillage winterVillage) {
    ...
    private void handle(CommandContext<CommandSource> context, @Nullable String reason) {
        ...
        this.winterVillage.playerHandler.lookupUniqueId(playerName)
                ...
                .thenCompose(playerPair -> {
                    ...
                    MuteInformation muteInformation = new MuteInformation(
                    ...
                    return this.winterVillage.playerDatabase.modify(punished.uniqueId(), builder -> builder.muteInformation(muteInformation))
                ...
                .thenAccept(punished -> {
                    ...
                    context.getSource().sendMessage(Component.join(
                            this.winterVillage.prefix,
                            Component.translatable("wintervillage.commands.punish.punished-mute",
